...
router.get('/my', authenticate, requireRole(4), getMyLeaves);
router.get('/balance', authenticate, requireRole(4), getLeaveBalance);
...
router.post('/', authenticate, requireRole(4), applyLeave);
router.delete('/:id', authenticate, requireRole(4), cancelLeave);
